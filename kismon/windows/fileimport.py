...
class FileImportWindow:
    ...
    def on_start(self, widget):
        ...
        num = 0
        for column in ("Файл", "Тип", "Сети", "Новые", "Статус"):
        ...
        self.close_button = Gtk.Button(label="Финиш")
