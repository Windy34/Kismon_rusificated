...
class SignalWindow:
    def __init__(self, mac, destroy, seconds=120):
        ...
        self.gtkwin.set_title("Граф сигнала: %s" % self.mac)
        ...
        num = 1
        for column in ("Имя", "Тип", "Уровень (дБ)", "Мин", "Макс", "Пакетов/сек", "Пакеты", "Сервер"):
    ...
    def draw_graph(self, width, height, ctx):
        ...
        while True:
            ...
            if len(r) > 6:  # максимум 6 горизонтальных линий
