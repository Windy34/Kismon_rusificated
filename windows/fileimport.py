...
class FileImportWindow:
    def __init__(self, networks, networks_queue_progress):
        ...
        self.gtkwin.set_title("Импорт файла")
    ...
    def create_file_chooser(self, add_type):
        ...
        if add_type == "file":
            ...
            filter.set_name("Все поддерживаемые файлы")
    ...
    def on_start(self, widget):
        ...
        num = 0
        for column in ("Файл", "Тип", "Сети", "Новый", "Статус"):
        ...
        self.progress_bar.set_text("0 из %s Файлов" % len(self.files))
        self.progress_bar.set_fraction(0)
        main_box.pack_start(self.progress_bar, expand=False, fill=True, padding=0)

        button_box = Gtk.VButtonBox()
        self.close_button = Gtk.Button(label="Завершить")
    ...
    def parse_file(self):
        ...
        self.progress_bar.set_text("%s из %s Файлов" % (pos, num_files))
